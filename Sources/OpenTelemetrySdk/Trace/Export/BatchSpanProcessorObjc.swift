...
@objc
public class BatchSpanProcessorObjc: NSObject {
...
//        super.init(batchSpanProcessor)
    ...
    public static func processor(_ spanExporter: SpanExporterObjc, scheduleDelay: TimeInterval = 5, exportTimeout: TimeInterval = 30,
                                 maxQueueSize: Int = 2048, maxExportBatchSize: Int = 512) -> BatchSpanProcessorObjc {
        return BatchSpanProcessorObjc(spanExporter: spanExporter, scheduleDelay: scheduleDelay, exportTimeout: exportTimeout, maxQueueSize: maxQueueSize, maxExportBatchSize: maxExportBatchSize)
    }
